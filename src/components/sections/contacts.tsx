...
const ContactSection = ({ header }: SectionProps) => {
  return (
    <section className={`mx-auto w-full max-w-7xl px-6 py-12 ${header ? "md:py-20" : "md:py-0"}`}>
      ...
      <div className="mt-8 w-full">
        <div className="flex flex-col justify-between lg:flex-row">
          ...
          <div className="text-gray mb-12">
            ...
            <p className="leading-relaxed">React, or Python systems, let&apos;s connect.</p>
          </div>
          {/* Message me section */}
          <div className="border-gray/70 bg-background border p-6">
            <h3 className="mb-6 text-lg font-medium text-white">Reach me directly via:</h3>
            <div className="space-y-4">
              ...
              <div className="text-gray flex items-center gap-3">
                <FaLinkedin size={24} />
                <a
                  href="https://www.linkedin.com/in/jeff-njau/"
                  target="_blank"
                  rel="noreferrer"
                  className="hover:underline focus:underline"
                >
              ...
              <div className="text-gray flex items-center gap-3">
                <FaReddit size={24} />
                <a
                  href="https://www.reddit.com/user/scented_dustbin"
                  target="_blank"
                  rel="noreferrer"
                  className="hover:underline focus:underline"
                >
