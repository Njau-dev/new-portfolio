...
const ClientProjectCard = ({ project }: ClientProjectCardProps) => {
    return (
        <Link href={`/work/${project.id}`}>
            <div className="border border-gray/70 bg-background p-6 hover:border-accent transition-all duration-300 group cursor-pointer h-full">
                {/* Header */}
                <div className="flex justify-between items-start mb-4">
                    <div>
                        ...
                        <h3 className="text-white text-xl font-semibold mb-1 group-hover:text-accent transition-colors">
                            {project.projectName}
                        </h3>
