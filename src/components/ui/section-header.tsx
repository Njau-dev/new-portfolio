...
const SectionHeader: React.FC<SectionHeaderProps> = ({ title, className = "", hero }) => {
  ...
  return (
    <div ref={rootRef} className={`mb-12 flex w-full items-center gap-4 ${className}`}>
      <h2 className="w-fit shrink-0 text-2xl font-medium text-white lowercase md:text-3xl">
      ...
      {hero ? (
        <div className="relative h-px w-full grow overflow-hidden bg-transparent">
          <div
