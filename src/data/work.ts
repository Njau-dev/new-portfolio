...
export const clientProjects: ClientProject[] = [
  {
    ...
    technologies: ["React", "Flask", "PostgreSQL", "Redis", "Cloudinary", "M-Pesa API", "Nginx"],
    overview:
    ...
    testimonial: {
      text: "The platform works exactly as we needed. Payments are reliable, the admin system is easy to use, and performance has been solid even with many products.",
  ...
  },
  {
    ...
    testimonial: {
      text: "The website gave our agency a professional image and helped us attract new clients quickly.",
      author: "Clinton",
  ...
  },
  {
    ...
    testimonial: {
      text: "The website is simple, clear, and easy for our clients to use. It meets exactly what we needed.",
      author: "Owner",
  ...
  },
  {
    ...
    testimonial: {
      text: "Our online visibility and branding improved significantly after the website launch and SEO updates.",
      author: "Ben",
