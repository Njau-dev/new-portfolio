...
export const projects: Project[] = [
  ...
  },
  {
    ...
    challenges: "Delivering a scalable marketplace architecture within a tight timeline.",
    solutions:
  ...
  },
  {
    ...
    challenges: "Stabilizing a bug-prone payroll module with complex compliance rules.",
    solutions:
  ...
  },
  {
    ...
    overview: "A fashion-focused e-commerce application built to explore full-stack product flows.",
    challenges:
  ...
  },
  {
    ...
    overview: "A clean agency website built to showcase services and attract clients.",
    challenges:
  ...
  },
  {
    ...
    overview: "An informational website presenting banking products and services.",
    challenges:
  ...
  },
  {
    ...
    duration: "2 months",
    role: "Frontend Developer",
    screenshots: ["/assets/ss-student.png", "/assets/ss-lecturer.png", "/assets/ss-admin.png"]
  },
  ...
  // ======================
  {
    ...
    overview: "A CLI tool that helps developers scaffold projects and inspect templates quickly.",
    features: [
  ...
  // ======================
  {
    ...
    solutions:
      "Utilized Wix's design tools for a modern look and implemented SEO best practices to boost visibility.",
    screenshots: [
      "/assets/kipepeo.png",
...
export const categories = [
  ...
  { value: "cli", label: "CLI Tools", count: projects.filter((p) => p.category === "cli").length },
  {
    value: "nocode",
    label: "No-Code",
    count: projects.filter((p) => p.category === "nocode").length
  }
];
